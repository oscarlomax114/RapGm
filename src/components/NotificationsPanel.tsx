    ...
    <div className="p-2 sm:p-4 space-y-3 sm:space-y-4">
      ...
      <div className="bg-neutral-950 border border-neutral-800 rounded-md p-4">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4">
          <div>
            <div className="text-neutral-500 text-xs">Total Events</div>
          ...
          <div>
            <div className="text-neutral-500 text-xs">Positive Money</div>
            <div className="text-green-700 font-semibold text-lg">
              {summary.positive}
            </div>
          </div>
          <div>
            <div className="text-neutral-500 text-xs">Negative Money</div>
      ...
      <div className="bg-neutral-950 border border-neutral-800 rounded-md p-3">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex items-center gap-1.5">
            <label className="text-neutral-500 text-xs">Impact</label>
            <select
              value={impactFilter}
        ...
        <div className="bg-neutral-950 border border-neutral-800 rounded-md overflow-hidden">
          <ul className="divide-y divide-gray-100">
            {pageSlice.map((event) => (
              <li
                key={event.id}
                className="px-4 py-3 flex gap-3 items-start hover:bg-black transition-colors"
              >
                <span
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline justify-between gap-2">
                    <span className="text-gray-100 text-xs font-semibold truncate">
                      {event.title}
                    </span>
